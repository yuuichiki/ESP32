...
LV_IMG_DECLARE(_btn2_alpha_191x247);
LV_IMG_DECLARE(_btn_bg_1_alpha_141x176);
LV_IMG_DECLARE(_no_internet_alpha_41x41);
LV_IMG_DECLARE(_btn2_alpha_141x176);
LV_IMG_DECLARE(_phone_alpha_75x97);
LV_IMG_DECLARE(_btn4_alpha_191x247);
LV_IMG_DECLARE(_btn4_alpha_141x176);
LV_IMG_DECLARE(_wifi_alpha_48x33);
LV_IMG_DECLARE(_mobile_alpha_50x50);
LV_IMG_DECLARE(_cloud_alpha_91x70);
LV_IMG_DECLARE(_print_alpha_48x48);
LV_IMG_DECLARE(_ready_alpha_166x166);
LV_IMG_DECLARE(_example_alpha_500x303);
LV_IMG_DECLARE(_example_alpha_416x241);
LV_IMG_DECLARE(_hue_alpha_35x35);
LV_IMG_DECLARE(_printer2_alpha_100x97);
LV_IMG_DECLARE(_tel_alpha_35x35);
LV_IMG_DECLARE(_bright_alpha_40x40);
LV_IMG_DECLARE(_eco_alpha_35x35);
LV_IMG_DECLARE(_btn3_alpha_191x247);
LV_IMG_DECLARE(_btn3_alpha_141x176);
LV_IMG_DECLARE(_internet_alpha_50x50);
LV_IMG_DECLARE(_setup_alpha_48x48);
LV_IMG_DECLARE(_usb_alpha_50x50);
LV_IMG_DECLARE(_pc_alpha_35x35);
LV_IMG_DECLARE(_copy_alpha_48x48);
LV_IMG_DECLARE(_scan_alpha_48x48);
LV_IMG_DECLARE(_wave_alpha_41x41);
